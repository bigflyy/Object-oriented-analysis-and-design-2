...
* **Разделение ответственности:** Создан отдельный класс `NoteMapper`, который инкапсулирует в себе всю логику перекладывания данных из Entity-объектов в Domain-объекты и обратно.
