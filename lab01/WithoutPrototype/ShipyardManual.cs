// ShipyardManual.cs — создание кораблей БЕЗ паттерна Прототип
// Имеет тот же интерфейс, что и Shipyard, но вместо клонирования
// каждый раз создаёт корабль заново через конструктор.
// Можно подставить вместо Shipyard в Form1 и всё будет работать,
// но без преимуществ паттерна.
...
namespace Prototype
{
    public class ShipyardManual
    {
        ...
        // Вот главное отличие: вместо Clone() — создаём новый объект напрямую.
