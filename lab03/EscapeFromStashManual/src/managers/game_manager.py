...
class GameManager:
    ...
    def __init__(self):
        stash = Stash(rent_cost=Config.RENT_COST, upgrade_rent_increase=Config.UPGRADE_RENT_INCREASE,
    ...
    def update(self, dt: float):
        ...
        if self._rent_timer >= Config.RENT_INTERVAL:
            ...
            self.flash_feedback(f"АРЕНДА: -{self.player.stash.rent_cost:.0f}₽", "yellow")
